...
export async function seedImpostazioni(prisma: PrismaClient) {
  ...
  const impostazioni: ImpostazioneSeed[] = [
    ...
    { chiave: 'monitor.keywords', valore: 'fine contratto\nfine noleggio\nfine locazione\neol\nend of lease\ngrenke\nrestituzione\nriscatto\nriacquisto\nproroga\nrinnovo\nscadenza contratto', tipo: 'TESTO', categoria: 'RECAPITI', label: 'Monitor casella: keyword', descrizione: 'Parole chiave (una per riga) che rendono rilevante una mail ricevuta su info@noleggiosumisura.it' },
