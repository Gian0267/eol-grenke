...
export async function seedImpostazioni(prisma: PrismaClient) {
  ...
  const impostazioni: ImpostazioneSeed[] = [
    ...
    { chiave: 'recapiti.ragione_sociale', valore: 'Integra Solutions Srl', tipo: 'TESTO', categoria: 'RECAPITI', label: 'Ragione sociale', descrizione: 'Ragione sociale completa per fatture e documenti ufficiali' },
    ...
    { chiave: 'pagamenti.intestatario', valore: 'Integra Solutions S.r.l.', tipo: 'TESTO', categoria: 'RECAPITI', label: 'Intestatario conto incassi', descrizione: 'Intestatario del conto corrente mostrato al cliente per il bonifico di riacquisto' },
    ...
    { chiave: 'recapiti.telefono_grenke', valore: '02-30082525', tipo: 'TESTO', categoria: 'RECAPITI', label: 'Telefono Grenke (fine noleggio)', descrizione: 'Numero Grenke indicato al cliente quando i termini di gestione Integra Solutions sono scaduti' },
