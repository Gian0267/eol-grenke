...
export async function seedImpostazioni(prisma: PrismaClient) {
  ...
  const impostazioni: ImpostazioneSeed[] = [
    ...
    { chiave: 'cliente.desc_opzione_rinnovo', valore: 'Prosegui con un nuovo contratto FLEX alle stesse condizioni e ricevi un premio fedelta.', tipo: 'TESTO', categoria: 'AREA_CLIENTE', label: 'Descrizione opzione rinnovo', descrizione: 'Testo descrittivo della card rinnovo' },
    { chiave: 'cliente.titolo_opzione_riacquisto', valore: 'Acquista il bene', tipo: 'TESTO', categoria: 'AREA_CLIENTE', label: 'Titolo opzione riacquisto', descrizione: 'Titolo della card riacquisto nell\'area cliente' },
    { chiave: 'cliente.desc_opzione_riacquisto', valore: 'Riscatta i beni in locazione al prezzo di riacquisto concordato.', tipo: 'TESTO', categoria: 'AREA_CLIENTE', label: 'Descrizione opzione riacquisto', descrizione: 'Testo descrittivo della card riacquisto' },
