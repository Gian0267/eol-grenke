...
const ISTRUZIONI_OPERATIVE = [
  ...
  'Spedisci il pacco a: Integra Systems Srl, Via Tunisia 5, 10093 Collegno (TO). Le spese di spedizione sono a carico del cliente.',
];
...
export async function generaVerbaleRestituzione(
  ...
  doc.fontSize(8).fillColor('#666666')
    .text('Noleggio Su Misura è la divisione rental di Integra Systems Srl');
