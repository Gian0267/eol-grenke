              ...
              {pratica.contratto.riacquisto_parziale && (
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6 text-sm">
                  ...
                  <p className="text-amber-900">
                    Questi dispositivi non rientrano nell'acquisto e vanno spediti a Integra Systems Srl,
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border p-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 max-h-48 overflow-y-auto text-xs text-gray-600 leading-relaxed mb-4">
                ...
                <p className="mb-2">5. Integra Systems Srl non presta garanzia sui beni ceduti, fatta salva la garanzia di legge per vizi occulti.</p>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border p-6 text-center">
              ...
              <input
                ...
                className="w-64 mx-auto block text-center text-3xl tracking-[0.4em] pl-[0.4em] font-mono border-2 border-gray-300 rounded-lg py-3 focus:border-[#2563eb] focus:outline-none"
                placeholder="______"
              />
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border p-6 text-center">
              ...
              <p className="text-sm text-gray-600 mt-4">
                ...
                {' '}26 giorni prima della scadenza del contratto.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl border p-6">
              ...
              <dl className="space-y-3 text-sm">
                <div>
                  ...
                  <dd className="font-medium text-[#1a3a52]">{configPagamento?.pagamento_intestatario || 'Integra Systems S.r.l.'}</dd>
                </div>
                <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                {state.metodo_pagamento === 'FABRICK' ? (
                  <div className="space-y-2 text-sm text-left">
                    ...
                    <div className="bg-white border rounded p-2"><span className="text-gray-400">Beneficiario:</span> Integra Systems Srl</div>
