...
const ISTRUZIONI = [
  ...
  { titolo: 'Spedisci a Collegno', testo: 'Spedisci a: Integra Systems Srl, Via Tunisia 5, 10093 Collegno (TO). Spese a carico del cliente.' },
];
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border p-6 text-center">
              ...
              <input
                ...
                className="w-64 mx-auto block text-center text-3xl tracking-[0.4em] pl-[0.4em] font-mono border-2 border-gray-300 rounded-lg py-3 focus:border-[#1a3a52] focus:outline-none"
                placeholder="______"
              />
