...
const ISTRUZIONI_RESTITUZIONE = [
  ...
  'Spedisci a: Integra Systems Srl, Via Tunisia 5, 10093 Collegno (TO). Spese a carico del cliente.',
];
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white rounded-lg border border-green-200 p-3">
                      ...
                      <p className="text-xs text-amber-700 bg-amber-50 rounded mt-2 px-2 py-1 text-center">
                        ...
                        NON paghi ora! Il pagamento ti sarà richiesto 26 giorni prima della scadenza.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <ol className="space-y-3 text-sm text-gray-700">
                ...
                {(risultatoSceltaBeni || sceltaBeni) === 'TENGO' && (
                  <li className="flex gap-3">
                    ...
                    Riceverai una email con le istruzioni per il pagamento dei beni 26 giorni prima della scadenza
                  </li>
                )}
                {(risultatoSceltaBeni || sceltaBeni) === 'RESTITUISCO' && (
                  <li className="flex gap-3">
